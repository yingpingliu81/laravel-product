                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{url('admin/blogs/create')}}" class="btn btn-primary pull-right">Create Blogs</a>
                                ...
                                <table class="table" id="blog-list">
                                    ...
                                    @foreach($blogs as $blog)
                                        <tr>
                                            ...
                                            <td >
                                                <img height="80" src="{{url($blog->thumbnail ?? "")}}" alt="">
                                            </td>
                                            ...
                                            <td >
                                                ...
                                                <form action="{{url('admin/blogs/'.$blog->id)}}"  method="post">
                                                    ...
                                                    <a href="{{url('blogs/'.$blog->slug)}}" class="ml-1" target="_blank"><span class="material-icons material-icons-outlined">open_in_browser</span></a>
...
@section('javascript')
    <script>
        ...
        function setVisible(element) {
            ...
            $.get('{{url("/")}}' + '/admin/blogs/' + blogId + '/visible', function( data ) {
                if(data.status === 1) {
        ...
        $(document).ready( function () {
            ...
            function handleDrop(e) {
                ...
                if (dragSrc != this) {
                    ...
                    $.get( '{{url("admin/blogs-sort?source=")}}' + $(dragSrc).children('td:first').text().trim() + '&dest=' + $(this).children('td:first').text().trim(), function( data ) {
                    });
                }
