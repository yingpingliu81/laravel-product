                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title ">Dealers & Installers List</h4>
                        </div>
                        <div class="card-body">
                            @include('layouts.message')

                            <a href="{{url('admin/dealers/create')}}" class="btn btn-primary pull-right">Create Dealer & Installer</a>
                            <div class="table-responsive">
                                <table class="table" id="dealer-list">
                                    ...
                                    @foreach($dealers as $dealer)
                                        <tr>
                                            ...
                                            <td >
                                                ...
                                                <form action="{{url('admin/dealers/'.$dealer->id)}}"  method="post">
...
@section('javascript')
    <script>
        ...
        function setVisible(element) {
            var dealerId = $(element).attr('data-dealerId');

            $.get('{{url("/")}}' + '/admin/dealers/' + dealerId + '/visible', function( data ) {
                if(data.status === 1) {
        ...
        $(document).ready( function () {
            ...
            var table = $('#dealer-list').DataTable({
                "aaSorting": [],
                pageLength: 50,
                columnDefs: [{
                    targets: '_all',
                ...
                drawCallback: function () {
                    ...
                    cells = document.querySelectorAll('#dealer-list tr');
            ...
            function handleDrop(e) {
                ...
                if (dragSrc != this) {
                    ...
                    $.get( '{{url("admin/dealers-sort?source=")}}' + $(dragSrc).children('td:first').text().trim() + '&dest=' + $(this).children('td:first').text().trim(), function( data ) {
                    });
                }
