                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{url('admin/faqs/create')}}" class="btn btn-primary pull-right">Create FAQ</a>
                                    ...
                                    @foreach($faqs as $blog)
                                        <tr>
                                            ...
                                            <td >
                                                ...
                                                <form action="{{url('admin/faqs/'.$blog->id)}}"  method="post">
                                                    <a href="{{url('admin/faqs/'.$blog->id.'/edit')}}">
...
@section('javascript')
    <script>
        ...
        function setVisible(element) {
            ...
            $.get('{{url("/")}}' + '/admin/faqs/' + blogId + '/visible', function( data ) {
                if(data.status === 1) {
        ...
        $(document).ready( function () {
            ...
            function handleDrop(e) {
                ...
                if (dragSrc != this) {
                    ...
                    $.get( '{{url("admin/faqs-sort?source=")}}' + $(dragSrc).children('td:first').text().trim() + '&dest=' + $(this).children('td:first').text().trim(), function( data ) {
                    });
                }
