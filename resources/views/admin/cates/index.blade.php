                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{url('admin/cates/create')}}" class="btn btn-primary pull-right">Create</a>
                                ...
                                <table class="table" id="product-list">
                                    ...
                                    @foreach($cates as $cate)
                                        <tr data-id="{{$cate->id}}">
                                            ...
                                            <td>
                                                {{$cate->products_count}}
                                                <a href="{{url('admin/products?cate='.$cate->id)}}" class="ml-4">
                                                    <icons-image _ngcontent-mes-c22="" _nghost-mes-c19=""><span class="material-icons material-icons-outlined">arrow_forward</span></icons-image _ngcontent-mes-c22="" _nghost-mes-c19="">
                                                </a>
                                            </td>

                                            <td >

                                                <form action="{{url('admin/cates/'.$cate->id)}}"  method="post">
                                                    <a href="{{url('admin/cates/'.$cate->id.'/edit')}}">
    ...
    $(document).ready( function () {
        ...
        function handleDrop(e) {
            ...
            if (dragSrc != this) {
                ...
                $.get( '{{url("admin/cates-sort?source=")}}' + $(dragSrc).children('td:first').text().trim() + '&dest=' + $(this).children('td:first').text().trim(), function( data ) {
                });
            }
