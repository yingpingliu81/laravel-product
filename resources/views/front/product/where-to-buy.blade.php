...
@section('title', 'Buy SolarKing Ventilation Fan across Australia - SolarKing')
    ...
    <div class="section">
        <div class="container">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="where-tass-tab" data-bs-toggle="tab" data-bs-target="#where-tas" href="#where-tas"  type="button" role="tab" aria-controls="where-tas" aria-selected="true">TAS</a>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="text-center mt-5 mb-5">
                <a href="{{url('support/approved-installers')}}" class="btn btn-customize2">Find Your Local Installer</a>
            </div>
        </div>
    </div>
