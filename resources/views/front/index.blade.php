    ...
    <div class="container">
        <div class="section1">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="imagestwo">
                        <img src="{{url('images/home/Solar-Roof-Ventilation-Solarking-16.jpg')}}" class="image1" alt="Roof Insulation"/>
                        <img src="{{url('images/home/Solarking-Perth-Solar-Roof-Vent.jpg')}}" class="image2" alt="Roof Ventilation"/>
                    </div>
                </div>
            </div>
        </div>
        <div class="section3 section">
            <div class="row">
                <div class="col-sm-6">
                    <div class="pic-big"><img src="images/5.png" alt="SolarKing lithium batteries" class="w-100 "></div>
                </div>
        ...
        <div class="section1">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="imagestwo">
                        <img src="{{url('images/home/RV-Solar-Panel-Image-1.jpg')}}" class="image1" alt="SolarKing lithium batteries"/>
                    </div>
                </div>
            </div>
        </div>
