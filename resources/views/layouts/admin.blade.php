...
<div class="wrapper ">
    <div class="sidebar" data-color="purple" data-background-color="white" data-image="/assets/img/sidebar-1.jpg">
        ...
        <div class="logo"><a href="{{url('/')}}" id="base_url" class="simple-text logo-normal">
                {{config('app.name')}}
            </a></div>
        <div class="sidebar-wrapper">
            <ul class="nav">
                ...
                <li class="nav-item {{Request::is('admin/cates*') ? 'active' : ''}} ">
                    <a class="nav-link" href="{{url('admin/cates')}}">
                        <i class="material-icons">library_books</i>
                        <p>Product Category</p>
                    </a>
                </li>

                <li class="nav-item {{Request::is('laravel-filemanager*') ? 'active' : ''}} ">
                    <a class="nav-link" href="{{url('laravel-filemanager?type=image')}}">
                        <i class="material-icons">upload_file</i>
                        <p>Files Managment</p>
                    </a>
                </li>

                <li class="nav-item {{Request::is('admin/dealers*') ? 'active' : ''}} ">
                    <a class="nav-link" href="{{url('admin/dealers')}}">
                        <i class="material-icons">assignment_ind</i>
                        <p>Dealers & Installers</p>
                    </a>
                </li>
                ...
                <li class="nav-item {{Request::is('admin/warranty*') ? 'active' : ''}} ">
                    <a class="nav-link" href="{{url('admin/warranty')}}">
...
<script src="https://cdn.tiny.cloud/1/vbf70c55i7hpf4szfvozgfgsln5de758nigh1c4d4oy2j7vy/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
...
<script>
    var lfm = function(id, type, options) {
        ...
        button.addEventListener('click', function () {
            ...
            var data_format = button.getAttribute('data-format');
            var base_url = document.getElementById('base_url').getAttribute('href');

            window.open( base_url + route_prefix + '?type=' + type || 'file', 'FileManager', 'width=900,height=600');
            window.SetUrl = function (items) {
                var file_paths = items.map(function (item) {
                    return item.url.replace(base_url, '');
                });
                // set the value of the desired input to image url
                target_input.value = data_format && "json" === data_format ? JSON.stringify(file_paths) : file_paths[0];
                target_input.dispatchEvent(new Event('change'));

                // clear previous preview
                if(target_preview) {
                    target_preview.innerHtml = '';
                    target_preview.textContent = '';
                    // set or change the preview image src
                    items.forEach(function (item) {
                        let img = document.createElement('img');
                        img.setAttribute('style', 'height: 5rem;margin-right:1rem');
